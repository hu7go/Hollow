...
public class RoomGenerator : MonoBehaviour
{
    ...
    [Header("The best value so far has been 48")]
    [Range(0, 100)]
    ...
    void CreatePassage(Room roomA, Room roomB, Coord tileA, Coord tileB)
    {
        ...
        Debug.DrawLine(CoordToWorldPoint(tileA), CoordToWorldPoint(tileB), Color.cyan);
    ...
    void RandomFillMap ()
    {
        if (useRandomSeed)
        {
            seed = Mathf.RoundToInt(UnityEngine.Random.Range(0, 1000)).ToString();
        }
    ...
    public void SpawnWall(Vector3 pos, int x, int y)
    {
        ...
        NeighbourLogic(closestNeighbour, tileWallComponent, null);
